...
<div class="content">
  ...
  <?php
             ...
             echo "<h1>Start a new course today $username!</h1>" ;
             }
                 ?>
  </p>
<div class="row">
  <div class="column">
      <img src="img/literacy.jpg" alt="Snow" style="width:100%"<h1>Is it a literacy you are looking for?</h1><a href="home.php" <button class="button button2">Start </button></a>
  </div>
    
  <div class="column">
      <img src="img/numeracy.jpg" alt="Forest" style="width:100%"<h1>Or is it numeracy?</h1><a href="numeracy.php" <button class="button button2">Start </button></a>
