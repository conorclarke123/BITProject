...
include "db_conn.php";
  ...
  $queryread2 = "SELECT * FROM ACHIEVEMENTS WHERE achievement_unlocked= 0";
...
<div class="content">
  ...
  <p> 
      <a href="achievementsunlocked.php" <button class="button button2">Unlocked </button></a> <a href="achievementslocked.php" <button class="button button4">Locked</button></a>
  </p>
  <?php
  ...
  <a target='_blank' href='$link'>
    <img src='$achievementimg' alt='' width='600' height='400'>
  </a>
  <div class='desc'>$achievementname</div>
             </div>";}?>
