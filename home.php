...
include "db_conn.php";
include "server.php";
$queryread = "SELECT * FROM STUDENT WHERE username= '$username'";
  ...
  $queryread2 = "SELECT * FROM COURSEDETAILS WHERE course_in_progress= 1";
