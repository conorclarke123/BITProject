...
include "db_conn.php";
  ...
  $queryread2 = "SELECT * FROM ACHIEVEMENTS WHERE achievement_unlocked= 1";
...
<div class="content">
  ...
  <p> 
      <a href="achievementsunlocked.php" <button class="button button4">Unlocked </button></a> <a href="homecompleted.php" <button class="button button2">Locked</button></a>
  </p>
  <?php
