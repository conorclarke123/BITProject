...
include "db_conn.php";
  ...
  $queryread2 = "SELECT * FROM COURSEDETAILS WHERE course_difficulty='Easy' AND course_genre='Numeracy'";
  ...
  <p> 
    ...
    <?php
             ...
             while($row3 = $resultread2->fetch_assoc()){
                 ...
                 $difficulty = $row3["course_difficulty"];
           echo"
  <div class='card'>
      <img src='$courseimg' width='100' height='100' alt='Avatar' >
  <div class='container'>
    <h4><b>$coursename</b></h4>
